...
Where \\(P_r(\theta)\\) is called the **Poisson Kernel**. The Poisson kernel has several intresting properties, which you can read more about [here](https://en.wikipedia.org/wiki/Poisson_kernel).
