...
\\(U(0) = \Phi (\xi)\\), where \\(\phi(\xi)\\) is simply the Fourier Transform of our initial condition and \\(\xi\\) is just a constant. Now, plugging 0 into \\(U\\) yields:
